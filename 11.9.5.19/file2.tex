...
\begin{align}
\frac{a + b}{2\sqrt{ab}} = \frac{m}{n} \label{eq:1}
\end{align}

Let's assume that $x = \sqrt{\frac{a}{b}}$. Then, we have:
\begin{align}
\frac{a}{b} = x^2 \label{eq:2}
\end{align}

Substituting this into the equation \eqref{eq:1}:
\begin{align}
...
\begin{align}
x = \frac{2}{n}\brak{m + \sqrt{m^2 - n^2}}
\end{align}

Referencing the value of $x$ from equation\eqref{eq:2}
\begin{align}
\frac{a}{b} &=\brak{\frac{2}{n}}^2 \brak{m + \sqrt{m^2 - n^2}}^2 
\end{align}

Multiplying both the numerator and denominator with \brak{$m-\sqrt{m^2 - n^2}$}: 
\begin{align} 
\frac{a}{b} &= \frac{4}{n^2} \frac{\brak{m + \sqrt{m^2 - n^2}}^2  \brak{m-\sqrt{m^2 - n^2}}}{\brak{m-\sqrt{m^2 - n^2}}}\\
