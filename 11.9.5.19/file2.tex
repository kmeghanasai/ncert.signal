...
Substituting this into the equation \eqref{eq:11.9.5.19eq1}:
\begin{align}
...
x &= \frac{2m}{n} \pm \frac{2}{n} \sqrt{m^2 - n^2}\label{eq:11.9.5.19eq6}
\end{align}

Since $x = \sqrt{\frac{a}{b}}$, $x$ must be positive.
\begin{align}
x = \frac{2}{n}\brak{m + \sqrt{m^2 - n^2}}\label{eq:11.9.5.19eq7}
\end{align}

Referencing the value of $x$ from equation\eqref{eq:11.9.5.19eq2}
\begin{align}
\frac{a}{b} &=\brak{\frac{2}{n}}^2 \brak{m + \sqrt{m^2 - n^2}}^2 \label{eq:11.9.5.19eq8}
\end{align}

Multiplying both the numerator and denominator with $\brak{m-\sqrt{m^2 - n^2}}$: 
\begin{align} 
\frac{a}{b} &= \frac{4}{n^2} \frac{\brak{m + \sqrt{m^2 - n^2}}^2  \brak{m-\sqrt{m^2 - n^2}}}{\brak{m-\sqrt{m^2 - n^2}}}\label{eq:11.9.5.19eq9}\\
a:b &= \brak{ m + \sqrt{m^2 - n^2}}: \brak{m - \sqrt{m^2 - n^2}}\label{eq:11.9.5.19eq10}
\end{align}
